    ...
    sidebarLayout(
      div(id = NS(id,"rosterSelector"),
          sidebarPanel(
            ...
            tags$span("Email your CSV-file roster(s) to the Commish by 1pm on 1/11/2025!", style="color:#E01713; font-weight:bold;"),
            tags$span("(Don't take a picture. Don't convert it to Excel. Don't text it to your mom. If you take a selfie with it, I literally die."),
            tags$span("Please, for the love of all that is sane in this world, reply to the Commish's email with your CSV-file roster(s) attached like people alive in 2025 should know how to do."),
